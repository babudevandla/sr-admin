...
<div id="page_content_inner">
  <h3 class="heading_b uk-margin-bottom">Add IMAGESTATUS</h3>

  <div class="md-card">
      <div class="md-card-content large-padding">
          <form id="form_validation" action="${contextPath}/admin/add_imagestatus"  method="post" enctype="multipart/form-data" class="uk-form-stacked">
	                        ...
	                        <div class="uk-width-medium-1-3 uk-row-first">
	                            <select name="type" style="width: 159px;" class="md-input" required="required">
	                            	<option	value="">please select type</option>
	                           		<option	value="IMAGESTATUS">IMAGESTATUS</option>
	                            </select>
	                        </div>
	                    </div>
	                   </div>
